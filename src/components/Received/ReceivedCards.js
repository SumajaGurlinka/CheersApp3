      ...
      >
        ...
        >
          ...
          <Tooltip title="Download All Cards">
              ...
              {/* <im sx={{ fontSize: "35px",  marginLeft: "20px",  color: "rgb(0 0 0 / 54%)", }} /> */}
              <img src={download} style={{fontsize:"30px",marginTop:"3px",marginLeft: "20px",width:"1.75em",height:"1.75em"  }}onClick={handleDownloadAll}></img>
                      ...
                      >
                        {row.viewed ? (
                          ...
                          <Tooltip title="Unviewed">
                           <IconButton sx={{ padding: "0px", marginLeft: "5px", marginRight: "7px" }}>
  <img src={unviewed} style={{ width: '20px', height: '1em' }} />
</IconButton>
                      ...
                      >
                        <Box sx={{ display: "flex", flexWrap: "wrap" }}>
                       {row.viewed?(   <Tooltip title="View Card">
                            <IconButton
                              onClick={() => handleViewCard(actualIndex)}
                            >
                          <VisibilityIcon/>
                            </IconButton>
                          </Tooltip>):(  <Tooltip title="View Card">
                            <IconButton
                              onClick={() => handleViewCard(actualIndex)}
                          ...
                          </Tooltip>:  <Tooltip title="Download Card">
                            <a
                              href={`data:image/jpeg;base64,${base64Image}`}
                              download={`${row.name}_${row.card}.jpg`}
                            >
                               <IconButton sx={{marginLeft:"6px"}}>
                             <img src={download1}></img></IconButton>
                            </a>
                          </Tooltip>}
                        </Box>
                      </TableCell>
