...
setConfirm(true);
  ...
  const handleSubmit = async (e) => {
    ...
    const subjectValue = formValues.subject.value;

    let newFormValues = { ...formValues };
    let hasError = false;

    if (subjectValue === "") {
      newFormValues.subject = {
        ...newFormValues.subject,
        error: true,
      ...
      newFormValues.subject = {
        ...newFormValues.subject,
        error: true,
        errorMessage: "Please enter Subject of 50 characters or less",
      };
      hasError = true;
    }
...
>
  ...
  <div style={{ marginLeft: "auto" }}>
    ...
    <Button style={{ background: "#0071e3", color: "#FCFCFC", borderRadius: "8px", textTransform: "none" ,marginRight:"32px",width:"80px"}}>
      Submit
    </Button>
  </div>
</div>
